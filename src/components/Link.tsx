...
export default function Link({ href, isRTL, background, children, ...rest }: LinkProps) {
    return (
        <a href={href} className={`flex ${isRTL ? "flex-row-reverse gap-2" : "flex-row"} text-blue-500 group items-center ${background ? "px-6 py-4 bg-white rounded-2xl" : ""}`} {...rest}>
